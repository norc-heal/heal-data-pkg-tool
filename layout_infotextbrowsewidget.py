...
from PyQt5.QtGui import QImage, QPainter, QTextCursor
from PyQt5.QtCore import QFile, Qt

import sys # base python, no pip install needed

from PyQt5.QtWidgets import QDialog, QApplication, QFileDialog, QTextBrowser
...
class InfoTextBrowserWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, infoText):
        ...
        self.userMessageBox.moveCursor(QTextCursor.Start)
